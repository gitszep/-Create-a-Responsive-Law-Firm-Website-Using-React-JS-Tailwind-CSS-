  ...
  return (
    <section id="team" className='section'>
        <div className='container mx-auto text-center'>
            ...
            <p className='max-w-[540px] mx-auto px-6 lg:px-0 mb-[60px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla officia quam porro
                soluta perspiciatis labore adipisci atque aut impedit deleniti.
            </p>
